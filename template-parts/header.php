...
<header class="<?php echo implode(' ', $classes) ?>">
    <div class="container">
        <div class="tgk-header-inner">
            ...
            <div class="tgk-header-menu-wrap">
            ...
            <div class="wrapper_phone">
                ...
                <div id="tgk-menu-open" class="d-md-none d-flex tgk-actions tgk-menu-open">
                    <span class="tgk-actions__text">
        ...
        <div style="width:100%; height:auto">
            <div class="logo_menu">
                <div class="logo">
                    ...
                    <a href="http://www.thutoanfashion.com.vn"><img style="padding-top:20px; max-width:250px" src="logo/1202/logo web.png" alt="Thu Toan Production Trading Service Co., Ltd."></a>
            ...
            <div style="width:100%; height:auto">
                <div style="padding-top:20px">
                    ...
                    <nav class="navbar navbar-expand-sm navbar-light" style="border-radius: 18px 18px 18px 18px">
                        ...
                        <a style="color:#222222   " class="navbar-brand" href="http://www.thutoanfashion.com.vn">HOME</a>
                        ...
                        <div class="collapse navbar-collapse" id="collapsibleNavbar">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a style="color:#222222   " class="nav-link" href="http://www.thutoanfashion.com.vn/aboutus">ABOUT US</a>
                                </li>
                                <!--else thietlapchung-->
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="http://www.thutoanfashion.com.vn/category/12176/polos.html" style="text-transform:uppercase">POLOS</a>

                                        <a class="dropdown-item" href="http://www.thutoanfashion.com.vn/category/12177/uniform-jackets.html" style="text-transform:uppercase">UNIFORM JACKETS</a>

                                        <a class="dropdown-item" href="http://www.thutoanfashion.com.vn/category/12178/uniform-shirts-for-office.html" style="text-transform:uppercase">UNIFORM SHIRTS FOR OFFICE</a>

                                        <a class="dropdown-item" href="http://www.thutoanfashion.com.vn/category/12182/office-uniforms.html" style="text-transform:uppercase">OFFICE UNIFORMS</a>

                                        <a class="dropdown-item" href="http://www.thutoanfashion.com.vn/category/12188/restaurant-and-hotel-staff-uniforms.html" style="text-transform:uppercase">RESTAURANT AND HOTEL STAFF UNIFORMS</a>

                                        <a class="dropdown-item" href="http://www.thutoanfashion.com.vn/category/12183/protective-clothing.html" style="text-transform:uppercase">PROTECTIVE CLOTHING</a>

                                        <a class="dropdown-item" href="http://www.thutoanfashion.com.vn/category/12184/hospital-uniforms.html" style="text-transform:uppercase">HOSPITAL UNIFORMS</a>

                                        <a class="dropdown-item" href="http://www.thutoanfashion.com.vn/category/12185/class-uniforms.html" style="text-transform:uppercase">CLASS UNIFORMS</a>

                                        <a class="dropdown-item" href="http://www.thutoanfashion.com.vn/category/12187/event-uniforms.html" style="text-transform:uppercase">EVENT UNIFORMS</a>

                                        <a class="dropdown-item" href="http://www.thutoanfashion.com.vn/category/12186/caps-and-hats.html" style="text-transform:uppercase">CAPS AND HATS</a>
                                ...
                                <li class="nav-item">
                                    <a style="color:#222222   " class="nav-link" href="http://www.thutoanfashion.com.vn/photo">PHOTO LIBRARY</a>
                                </li>

                                <li class="nav-item">
                                    <a style="color:#222222   " class="nav-link" href="http://www.thutoanfashion.com.vn/contact"><b>CONTACT INFORMATION</b></a>
                                </li>
